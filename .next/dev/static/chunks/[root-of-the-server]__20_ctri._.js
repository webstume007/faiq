...
"[project]/lib/db.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getActiveSession() {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('sessions').select('*').eq('is_active', true).single();
    return data;
}
async function createSession(sessionData) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('sessions').insert(sessionData).select().single();
    if (error) return {
        error: error.message
    };
    return {
...
async function getSessionCourses(sessionId) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('session_courses').select('*').eq('session_id', sessionId).order('course_name');
    return data || [];
}
...
async function getAllCourses() {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('session_courses').select(`*, session:sessions(name)`).order('course_name');
    return data || [];
}
...
async function submitChallanPayment(paymentData) {
    ...
    const { data: payment, error: payError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('challan_payments').insert(paymentData).select().single();
    if (payError) return {
...
async function verifyChallanPayment(paymentId, challanId, status, verifiedBy, rejectionReason) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('challan_payments').update({
        status,
...
async function getStudentResults(studentId) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('results').select(`
      *,
      subject:class_subjects(subject_name, subject_code)
...
async function upsertResult(resultData) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('results').upsert(resultData, {
...
async function updateAnnouncement(id, updates) {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('announcements').update({
        ...updates,
        updated_at: new Date().toISOString()
...
async function getDashboardStats() {
    const [students, teachers, guardians, pendingAdmissions, pendingChallans, announcements] = await Promise.all([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('announcements').select('id', {
            count: 'exact',
            head: true
        })
    ]);
...
async function globalSearch(query) {
    ...
    const [students, teachers, guardians] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('students').select('id, roll_no, first_name, last_name').or(`first_name.ilike.${searchTerm},last_name.ilike.${searchTerm},roll_no.ilike.${searchTerm}`).limit(5),
...
async function getTeacherClasses(teacherId) {
    const { data: subjectClasses } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('class_subjects').select(`
      *,
      class:session_classes(
        id, class_name, section, semester,
        course:session_courses(course_name, course_code),
...
async function getStudentsByClass(classId) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('students').select('id, roll_no, first_name, last_name, photo_url, status').eq('class_id', classId).eq('status', 'active').order('roll_no');
    return data || [];
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
const Icons = {
    ...
    arrowLeft: (s = 20, c = 'currentColor')=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
            width: s,
            height: s,
            viewBox: "0 0 24 24",
            fill: "none",
...
_c = Card;
const StatCard = ({ label, value, icon, color })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Card, {
        style: {
            display: 'flex',
            alignItems: 'center',
            gap: 16,
...
_c3 = Badge;
const InputField = ({ label, value, onChange, type = 'text', placeholder, required })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            marginBottom: 14
        },
        children: [
...
_c4 = InputField;
const SelectField = ({ label, value, onChange, options, required })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            marginBottom: 14
        },
        children: [
...
_c5 = SelectField;
const Modal = ({ title, onClose, children, width = 520 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            position: 'fixed',
            inset: 0,
            zIndex: 1000,
...
function DashboardSection() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardSection.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getDashboardStats"]().then(setStats);
        }
    }["DashboardSection.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardSection.useEffect": ()=>{
            ...
            const t = setTimeout({
                "DashboardSection.useEffect.t": async ()=>{
                    setSearching(true);
                    const results = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["globalSearch"](searchQuery);
                ...
                children: [
                    ...
                    searchResults && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    children: [
                                        ...
                                        searchResults[cat].map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    " ",
                                                    item.cnic && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        style: {
                                                            color: 'rgba(255,255,255,0.25)',
                                                            marginLeft: 8
                                                        },
                            ...
                            searchResults.students?.length === 0 && searchResults.teachers?.length === 0 && searchResults.guardians?.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    textAlign: 'center',
                                    color: 'rgba(255,255,255,0.3)',
                                    padding: 20,
...
_s(DashboardSection, "ppPyWz4aRg+JnM16GnZ8UB/Q6lQ=");
...
function TeachersSection() {
    ...
    const loadTeachers = async ()=>{
        setLoading(true);
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllTeachers"]();
        setTeachers(data);
        setLoading(false);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleCreate = async ()=>{
        setSaving(true);
        setMsg('');
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["createTeacher"]({
            cnic: formData.cnic,
...
_s1(TeachersSection, "iHk1upxeDOR6FFUfJn7vG+vspEQ=");
...
function SessionsSection() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [expandedSession, setExpandedSession] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [showCreateSession, setShowCreateSession] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [sessionForm, setSessionForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])({
        name: '',
        start_date: '',
        end_date: '',
        fee_structure: '{}'
    ...
    const load = async ()=>{
        ...
        const [s, cl, co] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllSessions"](),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllClasses"](),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllCourses"]()
        ]);
        setSessions(s);
        setClasses(cl);
        setCourses(co);
    ...
    const handleCreateSession = async ()=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["createSession"]({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Card, {
                    ...
                    children: [
                        ...
                        isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                session.fee_structure && typeof session.fee_structure === 'object' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    style: {
                                        marginBottom: 16
                                    },
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: Object.entries(session.fee_structure).map(([k, v])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    style: {
                                                        padding: '6px 12px',
                                                        background: 'rgba(255,255,255,0.04)',
                                                        borderRadius: 8,
            ...
            showCreateSession && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Modal, {
...
_s2(SessionsSection, "ptOgECXF8jc4dN+k7Rvzou/Y4Vw=");
...
function StudentsSection() {
    ...
    const load = async ()=>{
        setLoading(true);
        setStudents(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllStudents"]());
        setLoading(false);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleUpdate = async ()=>{
        setSaving(true);
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["updateStudent"](editingStudent.id, editForm);
...
_s3(StudentsSection, "oI4N9kb/lCwGKWxNv0ZQBF327tU=");
...
function AdmissionsSection() {
    ...
    const [adminNotes, setAdminNotes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [saving, setSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const load = async ()=>{
        setLoading(true);
        setAdmissions(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllAdmissions"]());
        setLoading(false);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleAction = async (status)=>{
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["updateAdmission"](selectedApp.id, {
            status,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                columns: columns,
                data: admissions,
                actions: (row)=>row.status === 'pending' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButton, {
                                icon: Icons.check(14),
                                title: "Approve",
                        ...
                        lineNumber: 711,
                        columnNumber: 11
                    }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButton, {
                        icon: Icons.eye(14),
                        title: "View",
                        color: GOLD,
            ...
            selectedApp && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Modal, {
                ...
                children: [
                    ...
                    selectedApp.status === 'pending' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    marginBottom: 14
                    ...
                    selectedApp.status !== 'pending' && selectedApp.admin_notes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            padding: 12,
                            background: 'rgba(255,255,255,0.04)',
                            borderRadius: 10,
...
_s4(AdmissionsSection, "v5C6m8obtUwFIbPKkukVa3M9qLg=");
...
function ChallansSection() {
    ...
    const [pendingPayments, setPendingPayments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [saving, setSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [reviewingPayment, setReviewingPayment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const load = async ()=>{
        setLoading(true);
        const [all, pending, studs] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllChallans"](),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getPendingChallans"](),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllStudents"]()
        ]);
        setChallans(all);
    ...
    const handleCreate = async ()=>{
        setSaving(true);
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["createChallan"]({
            ...form,
    ...
    const handleVerify = async (status)=>{
        ...
        if (payment) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["verifyChallanPayment"](payment.id, reviewingPayment.id, status, user?.id);
        }
        ...
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                actions: (row)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButton, {
                        icon: Icons.eye(14),
                        title: "View",
                        color: GOLD
                    }, void 0, false, {
            ...
            reviewingPayment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Modal, {
                ...
                children: [
                    ...
                    reviewingPayment.payment?.[0]?.screenshot_url && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            marginBottom: 16
                        },
                        children: [
...
_s5(ChallansSection, "sHvHnn+SSC28L63KwBjCdT9bpK0=");
...
function GuardiansSection() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GuardiansSection.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllGuardians"]().then({
...
function AnnouncementsSection() {
    ...
    const load = async ()=>{
        setLoading(true);
        setAnnouncements(await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllAnnouncements"]());
        setLoading(false);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleCreate = async ()=>{
        setSaving(true);
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["createAnnouncement"]({
            ...form,
            created_by: user?.id,
            target_roles: [
                'admin',
    ...
    const handleDelete = async (id)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__["deleteAnnouncement"](id);
        load();
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 982,
                    columnNumber: 20
                }, this) : announcements.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    style: {
                        textAlign: 'center',
                        padding: 40,
                        color: 'rgba(255,255,255,0.25)'
...
_s7(AnnouncementsSection, "WrO2Pra1dmWjanuos+7g8yQ4ioM=");
_c17 = AnnouncementsSection;
function AdminPortal() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminPortal.useEffect": ()=>{
            ...
            setUser(u);
            const checkMobile = {
                "AdminPortal.useEffect.checkMobile": ()=>setIsMobile(window.innerWidth < 900)
    ...
    const renderSection = ()=>{
        switch(activeSection){
            case 'dashboard':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DashboardSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1061,
                    columnNumber: 32
                }, this);
            case 'teachers':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TeachersSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1062,
                    columnNumber: 31
                }, this);
            case 'sessions':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SessionsSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1063,
                    columnNumber: 31
                }, this);
            case 'students':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StudentsSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1064,
                    columnNumber: 31
                }, this);
            case 'admissions':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AdmissionsSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1065,
                    columnNumber: 33
                }, this);
            case 'challans':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChallansSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1066,
                    columnNumber: 31
                }, this);
            case 'guardians':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GuardiansSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1067,
                    columnNumber: 32
                }, this);
            case 'announcements':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AnnouncementsSection, {}, void 0, false, {
                    fileName: "[project]/pages/admin.js",
                    lineNumber: 1068,
                    columnNumber: 36
                }, this);
...
_s8(AdminPortal, "BeksIwk5eLUXndJwnYnxNBIYCnA=", false, function() {
    return [
...
__turbopack_context__.k.register(_c17, "AnnouncementsSection");
__turbopack_context__.k.register(_c18, "AdminPortal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20_ctri._.js.map