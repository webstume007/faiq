...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["authenticateUser"])(cnic, password);
        if (!user) {
            setMessage({
                type: 'error',
    ...
    const handleSignup = async (e)=>{
        ...
        await new Promise((r)=>setTimeout(r, 600));
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createUser"])({
            firstName,
            lastName,
            cnic,
            phone,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10-3qz0._.js.map